  ...
  return (
    <div className="my-6">
      <div className="border-b flex gap-1 py-1">
        ...
        />
        <label
          className="font-semibold text-black/90 cursor-pointer"
          onClick={handleCheck}>
          {isAllSelected ? "Unselect all" : "Select All Similars"}
        </label>
      </div>
      {ch}
    </div>
...
export const SelectableItem = ({
  ...
  return (
    <div
      ...
      className={`my-2 cursor-pointer border rounded-xl overflow-hidden ${isSelected ? "border-fetch-primary bg-fetch-secondary/40 hover:bg-fetch-secondary/70" : " bg-slate-50/50 hover:bg-slate-100 border-black/15"}`}>
